...
module.exports = {
  ...
  opportunityWon: 'q=SELECT+Id,Name,OwnerId,AccountId,Amount,CloseDate,IsClosed,createdbyid,createddate,isdeleted,description,LastActivityDate,LastModifiedById,LastModifiedDate,LastReferencedDate,LastViewedDate,Type,IsWon+FROM+Opportunity+WHERE+isWon=true+AND+CloseDate>=',
